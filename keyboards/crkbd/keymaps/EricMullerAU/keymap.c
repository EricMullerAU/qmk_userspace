...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Layer BASE
    * /-----------------------------------------------\     /--------------------------------------------------\
    * |  Esc  |  q  |  w  |  e  |   r  |   t  | MO(3) |     | TOG(4) |   y   |   u   |  i  |  o  |  p  |  Bksp |
    * |-----------------------------------------------+     |--------------------------------------------------+
    * |  Tab  |  a  |  s  |  d  |   f  |   g  |   [   |     |    ]   |   h   |   j   |  k  |  l  |  ;  |   '   |
    * |-----------------------------------------------+     |--------------------------------------------------+
    * | LShft |  z  |  x  |  c  |   v  |   b  |-------|     |--------|   n   |   m   |  ,  |  .  |  /  | Enter |
    * \-------------------------\---------------------+     |------------------------/-------------------------/
    *                           | Ctrl | LGUI | space |     |  space | MO(1) | MO(2) |
    *                           \---------------------/     \------------------------/
    */
    [0] = LAYOUT_split_3x6_3_ex2(/* Base */
        KC_ESC,           KC_Q, KC_W, KC_E, KC_R,    KC_T,    TG(3),                  TG(4),          KC_Y,  KC_U,  KC_I,    KC_O,   KC_P,    KC_BSPC,
        KC_TAB,           KC_A, KC_S, KC_D, KC_F,    KC_G,    TD(TD_LBR_TAP),         TD(TD_RBR_TAP), KC_H,  KC_J,  KC_K,    KC_L,   KC_SCLN, KC_QUOT,
    ...
    */
    [1] = LAYOUT_split_3x6_3_ex2(/* FN1 */
        ...
        KC_NO,    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS,                KC_EQL, KC_NO,  KC_NO,  KC_NO, KC_NO, KC_NO, KC_HOME,
    ...
    * \-------------------------\-------------------+     |---------------------/---------------------------/
    *                           |     | Prev | Play |     | Play | Next | MO(2) |
    *                           \-------------------/     \---------------------/
    */
    [2] = LAYOUT_split_3x6_3_ex2(/* FN2 */
        KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR,  KC_PERC, KC_NO,            KC_NO,   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PGUP,
        KC_NO,   KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_BSLS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_UP,   KC_PGDN,
        KC_CAPS, KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT,
                                          KC_NO,   KC_MPRV, KC_MPLY,          KC_MPLY, KC_MNXT, KC_TRNS
    ),
    /* Layer RGB
    * /---------------------------------\     /------------------------------------------\
    ...
    */
    [4] = LAYOUT_split_3x6_3_ex2(/* Layer 4 */
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,           KC_TRNS, KC_NO, LCA(KC_U),    LCA(KC_UP),   LCA(KC_I),     KC_NO, KC_NO, 
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,           KC_NO,   KC_NO, LCA(KC_LEFT), LCA(KC_ENT),  LCA(KC_RIGHT), KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                           KC_NO, LCA(KC_J),    LCA(KC_DOWN), LCA(KC_K),     KC_NO, KC_NO, 
                                    KC_NO, KC_NO, KC_NO,           KC_NO,   KC_NO, KC_NO
    )
};
